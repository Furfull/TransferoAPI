using TransferoAPI.Config;
using Microsoft.Azure.Cosmos;
using Microsoft.Azure.Cosmos.Linq;
using System.Linq.Expressions;

namespace TransferoAPI.Data
{
    public class NoSQLDatabase<T>
    {
        ...
        private readonly string databaseId = "TransferoCosmosDB";
        ...
        public async Task<IEnumerable<T>> GetAllItens(string containerId)
        {
            ...
            Microsoft.Azure.Cosmos.Container container = database.GetContainer(containerId);
